...
const roadmapData = [
  ...
  },
  {
    ...
    cards: [
      ...
      { title: 'Постоянное улучшение и обновления', text: 'Поддерживать актуальность и конкурентоспособность платформы TOT', icon: 'Upgrade.svg' },
      { title: 'Сообщество и взаимодействие', text: 'Содействовать созданию активного и вовлечённого сообщества', icon: 'people connect.svg' },
    ]
  },
];
