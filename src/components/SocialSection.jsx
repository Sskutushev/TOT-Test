      ...
      <div className="social-container">
        <div className="social-left-column">
          <div className="social-text-container">
            ...
            {/* Кнопка для десктопа */}
            <a href="/social" className="social-details-btn desktop-only-btn btn btn-primary">Подробнее</a>
          </div>
        ...
        <a href="/social" className="social-details-btn mobile-only-btn btn btn-primary">Подробнее</a>
      </div>
    </section>
  );
};
